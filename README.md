...
2. Designing a truly responsive page, especially when almost all of the HTML was inserted via Javascript. It required essentially redesigning the various nav displays and while giving property declarations percentage values instead of pixels.
